...
import { initCustomers } from './customers.js?v=20260916-3';
import { initOrders } from './orders.js?v=20260916-3';
import { initFiles } from './files.js?v=20260916-3';
...
async function loadRoute() {
  ...
  try {
    const url = new URL(`./pages/${route.file}?v=20260916-3`, document.baseURI);
